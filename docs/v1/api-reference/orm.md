...
- **initDbms()** — Chooses the engine from **getenv("DB_TYPE")** and initializes the connector; see [Supported database systems](../getting-started/supported-databases.md). Called internally.
...
All methods are **async**. Filter and param shape are the same for all [supported database systems](../getting-started/supported-databases.md); see [Filters and params](../database/filters-and-params.md).
