...
Use **delete(filters, params)** to remove rows or documents. The same filter shape works for all [supported database systems](../getting-started/supported-databases.md).
...
If filters are omitted and bulk delete is allowed, behavior is implementation-specific; see [Supported database systems](../getting-started/supported-databases.md).
