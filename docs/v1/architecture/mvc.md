...
- **API:** Unified methods for all [supported database systems](../getting-started/supported-databases.md): `create`, `read`, `update`, `delete` (see [Database operations](../database/read.md) for details)
...
- **Model:** Handles all database communication for [supported database systems](../getting-started/supported-databases.md).
