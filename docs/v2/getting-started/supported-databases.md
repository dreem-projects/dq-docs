...
!!! info "One API for both"
    ...
    Filters and params use the same shape for MySQL and Mongo; see [Filters and params](../database/filters-and-params.md). You only need a running database and the correct `.env` when you use routes that call the ORM.
