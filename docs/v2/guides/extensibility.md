...
Use **config.CONFIG** or **getconfig** for feature flags, third-party URLs, or other app-specific options. Controllers and models can read these without hardcoding.
