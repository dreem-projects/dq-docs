...
> DQuode gives you the ability to group multiple routes into one file called the route groups. See [all about routes, groups in views here](../views/creating-views.md)
